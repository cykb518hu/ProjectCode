...
IF EXISTS (SELECT name FROM sys.indexes  
            WHERE name = N'IDX_DOCUMENT_CONTENT_DOC_GUID')   
    DROP INDEX IDX_DOCUMENT_CONTENT_DOC_GUID ON dbo.DOCUMENT_CONTENT;   
GO
create  NONCLUSTERED      index IDX_DOCUMENT_CONTENT_DOC_GUID  on dbo.DOCUMENT_CONTENT(DOC_GUID)
GO
