...
IF EXISTS (SELECT * FROM SYS.OBJECTS WHERE OBJECT_ID = OBJECT_ID(N'[dbo].[GET_DOC_CONTENT_Modify]') AND TYPE IN (N'P', N'PC'))
DROP PROCEDURE [dbo].[GET_DOC_CONTENT_Modify]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[GET_DOC_CONTENT_Modify]
(
@OrderByField nvarchar(100)=null,
@CityName varchar(max) =null,
@CountyName varchar(max) =null,
